...
def ploty_agent(state: State):
    ...
    prompt = (
        ...
        "Make sure the code runs without errors and bugs and does not include <script src=https://cdn.plot.ly/plotly-latest.min.js></script> INSTEAD INTERT include_plotlyjs='cdn' for each DIV!!! \n"
        "Thank you! \n"
    )
    #websearch = WebSearch()
