...
def ploty_enhancer_agent(state: State):
    llm = get_llm(model = 'o4-mini') #Lets make this llm use chat gpt 4o mini
    prompt = (
        ...
        "Return the full python code with plotly and the html/javascript code at the end without the use of the above script and having each div have include_plotlyjs='cdn'! \n "
        "Thank you! \n"
    )
    '''
    prompt = (
