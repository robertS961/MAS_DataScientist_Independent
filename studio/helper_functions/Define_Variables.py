...
def define_variables(thread: int, loop_limit: int, data:str, data_info:str , name:str = "research", input:str = "", code:str= "", data_description:str = "" ):
    if name == "research":
    #Define the Prompt to insert into the LLM
    ...
    elif name == "fix-plotly":
        prompt = (
            f"You are given code for a plotly graphs that runs but fails to do what I want.  Here it is \n {code} \n"
            f"The code is based on a tabular data set. Here are the data columns \n{data} \n"
            f"The columns have the following info \n {data_info} \n"
            ...
            "Also fix the bugs from the code like sometimes there is double pairs of columns that are referenced in the code, so make sure to aggregate them together for line plots, bar plots, etc. to display clear figures! \n"
        ...
        prompt = (
            ...
            "You shall take these ideas and turn them into plotly python code that creates beautiful graphs and visualizations \n"
