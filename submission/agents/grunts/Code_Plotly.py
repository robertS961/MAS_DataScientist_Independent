            ...
            update = {"messages":[
                {
                    ...
                    "content": (
                        ...
                        "Make sure everything is easy to see. NO overlapping buttons with button description, NO overlapping buttons with graph keys, NO Annotations overlapping with buttons,NO BUTTONS OVerLAPING Subtitles/TITLES, NO OVERLAPING graph keys/legends/toggles and heatmap keys, and NO white out hover/selected buttons!\n"
