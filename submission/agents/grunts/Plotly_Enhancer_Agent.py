...
def ploty_enhancer_agent(state: State):
    ...
    prompt = (
        ...
        "The description of what the button does that goes away once the button is selected is normally right under the button. IT IS UNREADABLE, please remove this! NO BUTTON descriptions that disappear when the button is click!\n"
