...
def ploty_enhancer_agent(state: State):
    ...
    prompt = (
        ...
        "Return the full python code with plotly and the html/javascript code at the end without the use of script noted above and instead include_plotlyjs='cdn' for each div! \n "
        "Thank you! \n"
    )
    '''
    prompt = (
