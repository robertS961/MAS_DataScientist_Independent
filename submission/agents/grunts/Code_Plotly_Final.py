            ...
            update = {"messages":[
                {
                    ...
                    "content": (
                        ...
                        "Make sure each graph has a paragraph description about what the graph shows and how to interpret it, like what would be impactful findings in the graph \n"
